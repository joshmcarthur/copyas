...
coverage_report="$(
    xcrun llvm-cov report "${test_binary}" \
        ...
        -ignore-filename-regex="(/Tests/|/\\.build/|/Sources/CopyasCLI/|/Sources/Copyas/Model/LiveModelClient\\.swift$|/Sources/Copyas/Model/FoundationModelsTokenCounter\\.swift$|/Sources/Copyas/Model/FMToolLanguageModel\\.swift$)"
)"
