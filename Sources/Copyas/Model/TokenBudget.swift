...
public struct FoundationModelsTokenCounter: Sendable {
...
public struct TokenBudget: Sendable {
    ...
    private let tokenCounter: FoundationModelsTokenCounter

    public init(tokenCounter: FoundationModelsTokenCounter = FoundationModelsTokenCounter()) {
